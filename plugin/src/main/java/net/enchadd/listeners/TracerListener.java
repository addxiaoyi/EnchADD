...
public class TracerListener implements Listener {

    private final Registry<Enchantment> registry = RegistryAccess.registryAccess().getRegistry(RegistryKey.ENCHANTMENT);
    private Enchantment enchant = registry.get(TracerEnchant.KEY);
    private TracerEnchant config;

    public TracerListener() {
        Object enchantObj = EnchADDConfig.ENCHANTS.get(TracerEnchant.KEY);
        this.config = (enchantObj instanceof TracerEnchant) ? (TracerEnchant) enchantObj : null;
    }
