...
public class SoulboundEnchant extends AbstractEnchADDEnchant {

    public static final Key KEY = Key.key("enchadd:soulbound");
    ...
    public @NotNull Iterable<EquipmentSlotGroup> getActiveSlots() {
        return java.util.Set.of(EquipmentSlotGroup.ANY);
    }

    public static SoulboundEnchant create(ConfigurationSection configurationSection) {
        boolean enabled = EnchADDConfig.getBoolean(configurationSection, "enabled", true);
        String rarity = configurationSection.getString("rarity", "COMMON"); // Suggestion 16
        ...
        if (enabled) {
            net.enchadd.EnchADDConfig.ENCHANTS.put(SoulboundEnchant.KEY, soulboundEnchant);
        }
