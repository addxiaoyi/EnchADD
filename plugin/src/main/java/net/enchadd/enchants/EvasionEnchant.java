...
public class EvasionEnchant extends ChanceEnchant {

    public static final Key KEY = Key.key("enchadd:evasion");
    ...
    private EvasionEnchant(int anvilCost,
            int weight,
    ...
    public static EvasionEnchant create(ConfigurationSection configurationSection) {
        boolean enabled = EnchADDConfig.getBoolean(configurationSection, "enabled", true);
        String rarity = configurationSection.getString("rarity", "COMMON");
        EvasionEnchant enchant = new EvasionEnchant(EnchADDConfig.getInt(configurationSection, "anvilCost", 1),
        ...
        if (enabled) {
            net.enchadd.EnchADDConfig.ENCHANTS.put(EvasionEnchant.KEY, enchant);
    }
        return enchant;
    }
}
