...
public class HomecomingEnchant extends AbstractEnchADDEnchant {

    public static final Key KEY = Key.key("enchadd:homecoming");
    ...
    public HomecomingEnchant(int anvilCost,
            int weight,
    ...
    public static HomecomingEnchant create(ConfigurationSection configurationSection) {
        ...
        HomecomingEnchant homecomingEnchant = new HomecomingEnchant(EnchADDConfig.getInt(configurationSection, "anvilCost", 1),
        ...
        if (enabled) {
            net.enchadd.EnchADDConfig.ENCHANTS.put(HomecomingEnchant.KEY, homecomingEnchant);
        }
