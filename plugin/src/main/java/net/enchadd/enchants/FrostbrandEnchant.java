...
public class FrostbrandEnchant extends ChanceEnchant {

    public static final Key KEY = Key.key("enchadd:frostbrand");
    ...
    private FrostbrandEnchant(int anvilCost,
            int weight,
    ...
    public static FrostbrandEnchant create(ConfigurationSection configurationSection) {
        boolean enabled = EnchADDConfig.getBoolean(configurationSection, "enabled", true);
        String rarity = configurationSection.getString("rarity", "COMMON");
        FrostbrandEnchant enchant = new FrostbrandEnchant(EnchADDConfig.getInt(configurationSection, "anvilCost", 2),
                ...
                EnchADDConfig.getInt(configurationSection, "cooldownTicks", 40),
        ...
        if (enabled) {
            net.enchadd.EnchADDConfig.ENCHANTS.put(FrostbrandEnchant.KEY, enchant);
    }
        return enchant;
    }
}
