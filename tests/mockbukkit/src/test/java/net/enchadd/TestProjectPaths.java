...
final class TestProjectPaths {
    ...
    private static Path locateRepoRoot() {
        ...
        while (current != null) {
            ...
            Path mockbukkitModule = current.resolve(Path.of("tests", "mockbukkit"));
            if (Files.isDirectory(pluginMain) && Files.isDirectory(mockbukkitModule)) {
                return current;
            }
