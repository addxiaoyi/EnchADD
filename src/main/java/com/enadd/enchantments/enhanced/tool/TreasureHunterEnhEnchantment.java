...
public class TreasureHunterEnhEnchantment extends EnhancedToolEnchantment {
    public TreasureHunterEnhEnchantment() {
        super(EnhancedEnchantmentRegistry.getEnchantmentData("treasure_hunter_enh"));
    }

    @Override
    public boolean conflictsWith(org.bukkit.enchantments.Enchantment other) {
        return other instanceof TreasureHunterEnhEnchantment;
    }
}
