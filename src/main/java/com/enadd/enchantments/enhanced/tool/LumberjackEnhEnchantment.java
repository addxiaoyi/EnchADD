...
public class LumberjackEnhEnchantment extends EnhancedToolEnchantment {
    public LumberjackEnhEnchantment() {
        super(EnhancedEnchantmentRegistry.getEnchantmentData("lumberjack_enh"));
    }

    @Override
    public boolean conflictsWith(org.bukkit.enchantments.Enchantment other) {
        return other instanceof LumberjackEnhEnchantment;
    }
}
